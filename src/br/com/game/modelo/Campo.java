...
import br.com.game.excecao.ExplocaoException;
...
public class Campo {
    ...
    private List<Campo> vizinhos = new ArrayList<>();// auto relacionamento no bd. 1,n. private para garantir que tenha
                                                     // o encapsulamento, responsabilidade do campo
    ...
    boolean addVizinho(Campo vizinho) {
        ...
        boolean diagonal = linhaDiferente && colunaDiferente;// Para que seja diagonal, ambas as linhas e colunas devem
                                                             // ser diferentes.
